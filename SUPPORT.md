...
SmartScreen may warn because releases do not use Authenticode. Verify the installer with PowerShell `Get-FileHash -Algorithm SHA256` and compare it with the versioned `SHA256SUMS` published beside the installer.
